                                                ...
                                                @if(Route::has('login'))
                                                   @auth
                                                       @if(Auth::user()->utype === 'ADM')
                                                          ...
                                                          <li>
                                                             <a href="{{route('admin.contact')}}" class="d-block">Contact message</a>
                                                          </li>
                                                       @else
                                                            <li>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img style=" width: 140px; height: 80px;" src="{{asset('assets/images/logo.jpg')}}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Address:</b><span class="font-light"> ECE Paris</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@agorafrancia.in</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="index.htm" class="font-white">Home</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-white">Shop</a>
                                    </li>
                                    <li>
                                        <a href="about-us.html" class="font-white">About Us</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-white">Blog</a>
                                    </li>
                                    <li>
                                        <a href="contact-us.html" class="font-white">Contact Us</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="shop.html" class="font-white">Latest Shoes</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-white">Branded Jeans</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-white">New Jackets</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-white">Colorfull Hoodies</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-white">Shiner Goggles</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="#" class="white-white">Your Orders</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-white">Your Account</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-white">Track Orders</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-white">Your Wishlist</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-white">Shopping FAQs</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Agora Francia</p>
                    </div>
                </div>
            </div>
        </div>
