...
<section class="pt-0 poster-section">
        <div class="poster-image slider-for custome-arrow classic-arrow">
            <div>
                <img src="assets/images/1.png" class="img-fluid blur-up lazyload" alt="">
            </div>
            <div>
        ...
        <div class="left-side-contain">
            <div class="banner-left">
                <h1>Welcome to <span>AGORA Francia</span></h1>
                <p>Discover a unique shopping experience where style meet convenience </p>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <i class="fa fa-cube" aria-hidden="true"></i>
                        <h4 class="mb-2">Free shepping</h4>
                ...
                <div class="col-md-3">
                    ...
                    <i class="fa fa-eur" aria-hidden="true"></i>
                        <h4 class="mb-2">Money Garanted</h4>
                        <span>BUY ONE GET ONE FREE</span>
                     </div>
                </div>
                <div class="col-md-3">
                    ...
                    <i class="fa fa-headphone"></i>
                        <h4 class="mb-2">Online support</h4>
                        <span>BUY ONE GET ONE FREE</span>
                    </div>
                </div>
                <div class="col-md-3">
                    ...
                    <i class="far fa-credit-card"></i>
                        <h4 class="mb-2">Flexible payment</h4>
                        <span>BUY ONE GET ONE FREE</span>
                    </div>
                </div>
